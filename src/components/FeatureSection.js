            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <FadeInSection direction="left">
                    <div className="relative">
                        ...
                        />
                        <div className="absolute -bottom-10 -right-10 w-64 bg-white p-6 rounded-2xl shadow-xl z-20 hidden md:block animate-float">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                                    <CheckCircle className="text-emerald-600 w-6 h-6" />
                                </div>
                                <div>
                                    <h4 className="font-bold text-slate-900">Verified Stays</h4>
                                    <p className="text-xs text-slate-500">Only the best for you</p>
                                </div>
                            </div>
                ...
                <FadeInSection direction="right">
                    <div>
                        <h4 className="text-emerald-600 font-bold uppercase tracking-widest mb-2">Why Choose Us</h4>
                        <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-6 leading-tight">
                            We redefine the art of <br /> <span className="italic text-slate-400">luxury living</span>.
                        </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={idx} className="flex gap-4">
                                    <div className="w-12 h-12 bg-white shadow-md rounded-xl flex items-center justify-center shrink-0 text-emerald-600">
